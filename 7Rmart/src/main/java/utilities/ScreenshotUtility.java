...
public class ScreenshotUtility {
	public void getScreenShot(WebDriver driver, String failedTestCase) throws IOException {
		...
		//selenium webdriver cannot take screenshots directly so typecast to take screenshot
		File screenShot = scrShot.getScreenshotAs(OutputType.FILE);  //capture the screenshot-store it temporarly as a file
		String timeStamp = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss").format(new Date());//create data and time(date is a class to get current date)
